...
class $AssetsIconsGen {
  ...
  List<SvgGenImage> get values =>
      [applicationCard, balance, menu, posCafe, voucher];
}

class $AssetsImagesGen {
  const $AssetsImagesGen();

  /// File path: assets/images/elkopra.png
  AssetGenImage get elkopra => const AssetGenImage('assets/images/elkopra.png');

  /// File path: assets/images/no-transaction.png
  AssetGenImage get noTransaction =>
      const AssetGenImage('assets/images/no-transaction.png');
  ...
  /// List of all assets
  List<AssetGenImage> get values => [elkopra, noTransaction, profilePicture];
}
